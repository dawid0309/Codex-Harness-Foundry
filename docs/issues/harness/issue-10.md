# Issue #10: Replace runtime stop loops with one-cycle harness worker policy
...
- Keep future continuation policy as an explicit harness feature rather than an implicit runtime loop.
