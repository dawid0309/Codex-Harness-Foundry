...
FRAMES = [
    ...
    },
    {
        ...
        "body": [
            ...
            "- M1-T001 [P0] Assemble the agents-md context skeleton -> planner",
            "==> Typecheck",
            "==> Smoke",
        ...
        "highlights": {
            ...
            "- M1-T001 [P0] Assemble the agents-md context skeleton -> planner": SUCCESS,
    ...
    },
    {
        ...
        "highlights": {"- M1-T001 [P0] Assemble the agents-md context skeleton -> planner": SUCCESS},
    },
    {
        ...
        "body": [
            ...
            "Tasks:",
            "- M1-T001 [ready] [P0] Assemble the agents-md context skeleton -> planner",
        ...
        "highlights": {
            ...
            "- M1-T001 [ready] [P0] Assemble the agents-md context skeleton -> planner": SUCCESS,
